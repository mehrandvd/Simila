...
namespace Simila.Core.Tests
{
    ...
    public class CharacterMistakeBasedSimilarityResolverTests
    {
        ...
        {
            var simila = new CharacterSimilarityResolverDefault(StringComparisonOptions.CaseSensitive);
        ...
        {
            var simila = new CharacterSimilarityResolverDefault(StringComparisonOptions.None);
        ...
        {
            var simila = new CharacterSimilarityResolverDefault(stringComparisonOptions: StringComparisonOptions.None) { CostOfNumeric = 0.3f };
